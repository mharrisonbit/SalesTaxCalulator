...
namespace SalesTaxCalculator.Models
{
    ...
    public partial class TaxRate
    {
        public static TaxRate FromJson(string json) => JsonConvert.DeserializeObject<TaxRate>(json, SalesTaxCalculator.Models.TaxRateConverter.Settings);
    }

    public static class TaxRateSerialize
    {
        public static string ToJson(this TaxRate self) => JsonConvert.SerializeObject(self, SalesTaxCalculator.Models.TaxRateConverter.Settings);
    }
